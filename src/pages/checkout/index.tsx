...
const Checkout = ({ onVoltar, onContinuarPagamento }: CheckoutProps) => {
  ...
  const formEntrega = useFormik({
    ...
    validationSchema: Yup.object({
      ...
      cep: Yup.string().length(9, "CEP deve ter 9 dígitos").required("Campo obrigatório"),
      numero: Yup.string().min(1, "Número inválido").required("Campo obrigatório"),
            ...
            <Row>
              ...
              <GropuCad>
                ...
                <input
                  ...
                  onBlur={formEntrega.handleBlur}
                />
                {formEntrega.touched.numero && formEntrega.errors.numero && <span>{formEntrega.errors.numero}</span>}
              </GropuCad>
            </Row>
